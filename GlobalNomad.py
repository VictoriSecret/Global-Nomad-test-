...
title_lb = ttk.Label(text='Global Nomad', background="#FAFAFA", font=('Montserrat Alternates', 64))
title_lb.pack(anchor='center', pady=140)
label1 = ttk.Label(text="Введите данные для входа", background="#FAFAFA", font=("Montserrat", 12), foreground="#625D5D")
...
btn_enter = Button(text="Войти", bg='#162013', width=20, fg="#FFFFFF",
                   font=("Montserrat", 12), command=travel_packages)
btn_enter.place(x=360, y=500, height=45)

# кнопка регистрации
btn_registr = Button(text="Регистрация", width=15, fg="#000000",
